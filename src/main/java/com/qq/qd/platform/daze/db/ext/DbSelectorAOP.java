...
import com.qq.qd.platform.daze.configuration.DatasourceConfiguration;
...
public class DbSelectorAOP {
    ...
    @Pointcut("within(com.qq.qd.platform.daze.service.DataAccessService)" +
            "&& @annotation(com.qq.qd.platform.daze.db.ext.DbSelector)")
